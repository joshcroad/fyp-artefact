...
var search = {
  ...
  conduct: function (min, max) {
    ...
    file.write('mongo', 'Time (nanoseconds) to find 1 record in n records.');
    file.write('redis', 'Time (nanoseconds) to find 1 record in n records.');
    file.setTitle('Time (nanoseconds) to find 1 record in n records.');
