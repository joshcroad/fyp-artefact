...
var write = {
  ...
  conduct: function (min, max) {
    ...
    file.write('mongo', 'Time (nanoseconds) to write n records.\n');
    file.setTitle('Time (nanoseconds) to write n records.');
    ...
    .then(function (data) {
      log.dbComplete(data);
      file.write('redis', 'Time (nanoseconds) to write n records.\n');
